  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: 800, mx: "auto" }}>
        <Typography
          variant="h4"
          sx={{ mb: 4, fontWeight: 600, color: isDark ? "#fff" : "#000" }}
        >
          Settings
        </Typography>
        <ParentalSettings />
        ...
        >
          <Typography
            variant="h6"
            sx={{ mb: 3, fontWeight: 500, color: isDark ? "#fff" : "#000" }}
          >
            Appearance & Branding
          </Typography>

          <Typography
            sx={{ mb: 2, color: isDark ? "#aaa" : "#666", fontSize: "0.9rem" }}
          >
            Select your preferred accent color for menus, buttons, and
            highlights across the application.
          </Typography>
